...
"""
    ...
    'navigation': {
        ...
        'clear': 'Очистить все',
        'footer_farina': 'Farina',
        'footer_mad': 'MAD',
        'footer_cheb': 'ЧБКафе',
        'footer_thecrew': 'TheCrew',
    },
...
Вы вводите: {text}""",
        'names_found': """Похоже найдены совпадения
{name}, выберите имя, если считаете, что это вы, или нажмите <code>это не я</code>, чтобы пропустить"""
    },
